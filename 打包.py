...
# 假设这是你现有的代码
os.system('pyinstaller --onefile -w --add-data "src/gif.gif;src/" --add-data "src/bgm.ogg;src/" --add-data "src/bg2.jpg;src/" --add-data "src/ico/advanced.png;src/ico/" main.pyw')
os.remove('main.spec')
